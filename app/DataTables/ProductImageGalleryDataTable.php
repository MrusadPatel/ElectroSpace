...
class ProductImageGalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $deleteBtn = "<form action='".route('product-image-gallery.destroy',$query->id)."' method='POST' style='display:inline;'>
                        ".csrf_field()."
                        ".method_field('DELETE')."
        ...
        ->addColumn('image',function($query){
            return $img= "<img style='height:90px ; width:120px' src='".asset($query->image)."'></img>";
        })
